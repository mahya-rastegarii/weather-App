...
const Weather = ({weather, units}) => {
    ...
    return ( 
            ...
            <div className="flex justify-between items-center bg-bgColor w-full  rounded-md px-5 py-4 lg:px-5 lg:py-9  md:w-2/4">
            ...
            <div className="flex justify-center items-center font-bold text-3xl md:text-5xl  text-white">
